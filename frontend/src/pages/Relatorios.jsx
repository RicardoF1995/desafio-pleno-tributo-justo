                        ...
                        .map((empresa) => {
                            ...
                            return (
                                <React.Fragment key={empresa.id}>
                                    ...
                                    <tr className="rodape-empresa">
                                        <td colSpan="3"><strong>Total da Empresa</strong></td>
                                        <td>
                                            <strong>
                                                {notasFiltradas.reduce((soma, n) => soma + n.valorTotal, 0).toLocaleString("pt-BR", { style: "currency", currency: "BRL" })}
                                            </strong>
                                        </td>
                                        <td>
                                            <strong>
                                                {notasFiltradas.reduce((soma, n) => soma + n.impostoRecolhido, 0).toLocaleString("pt-BR", { style: "currency", currency: "BRL" })}
                                            </strong>
                                        </td>
                                        <td>
                                            <strong>
                                                Média da diferença - {(
                                                    notasFiltradas.reduce((soma, n) => soma + n.diferenca, 0) / notasFiltradas.length
